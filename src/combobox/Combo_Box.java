...
public class Combo_Box<E> extends JComboBox<E> {
    ...
    private class ComboUI extends BasicComboBoxUI {
        ...
        private Combo_Box combo;

        public ComboUI(Combo_Box combo) {
            this.combo = combo;
...
//        @Override
        ...
        public void paint(Graphics grphcs, JComponent jc) {
            ...
            g2.fillRoundRect(2, height - 1, width - 4, 1, 5, 5);
            createHintText(g2);
            createLineStyle(g2);
            g2.dispose();
        }
        ...
        private void createLineStyle(Graphics2D g2) {
            if (isFocusOwner()) {
                ...
                g2.fillRoundRect((int) (x + 2), height - 2, (int) size, 2, 5, 5);
            }
        }
